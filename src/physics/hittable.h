...
class Hittable {
    public:
         ...
         */
        virtual optional<Ray> scatter_ray_on_hit(Ray r) const = 0;
         ...
         */
        bool hit(optional<Ray> scattered_ray) const { return scattered_ray.has_value(); }
         ...
         */
        optional<double> hit_distance_squared(Ray incoming, optional<Ray> scattered) const {
